...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.args=configs
        if 'elect' in configs.data_type:
            if configs.grand=='4h':
                self.n_time_in=configs.seq_len*6
            elif configs.grand=='12h':
                self.n_time_in = configs.seq_len * 2
            elif configs.grand == '1h':
                self.n_time_in = configs.seq_len * 24
            else:
